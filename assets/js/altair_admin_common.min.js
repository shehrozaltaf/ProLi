...
$(function () {
    ...
    this.positionDropdown = function () {
        var e = this.$control, i = e.position(), a = i.left, t = i.top + e.outerHeight(!0) + 32;
        this.$dropdown.css({width: e.outerWidth(), top: t, left: a})
    }
}), Selectize.define("tooltip", function (e) {
    var i, a = this;
    this.setup = (i = a.setup, function () {
        i.apply(this, arguments);
        var e = this.$wrapper, a = this.$input;
        a.attr("title") && e.attr("title", a.attr("title")).attr("data-uk-tooltip", a.attr("data-uk-tooltip"))
    })
    ...
    if ("multi" === this.settings.mode) {
        ...
        n.lock = (i = n.lock, function () {
            ...
            var e = n.$control.sortable({
                items: "[data-value]",
                forcePlaceholderSize: !0,
                disabled: n.isLocked,
                start: function (i, a) {
                    a.placeholder.css("width", a.helper.css("width")), e.css({overflow: "visible"})
                },
                stop: function () {
                    e.css({overflow: "hidden"});
                    var i = n.$activeItems ? n.$activeItems.slice() : null, a = [];
                    e.children("[data-value]").each(function () {
                        a.push($(this).attr("data-value"))
                    }), n.setValue(a), n.setActiveItem(i)
                },
                helper: function (e, i) {
                    var a = $(i).clone();
    ...
    e = $.extend({label: "&times;", title: "Remove", className: "remove", append: !0}, e);
    var i, a, t, n, s, r = function (e) {
        return (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;")
    };
    "single" !== this.settings.mode ? (n = i = this, s = '<a href="javascript:void(0)" class="' + (a = e).className + '" tabindex="-1" title="' + r(a.title) + '">' + a.label + "</a>", i.setup = (t = n.setup, function () {
        if (a.append) {
            var e = n.settings.render.item;
            n.settings.render.item = function (a) {
                return t = e.apply(i, arguments), n = s, r = t.search(/(<\/[^>]+>\s*)$/), t.substring(0, r) + n + t.substring(r);
                var t, n, r
            }
        }
        t.apply(i, arguments), i.$control.on("click", "." + a.className, function (e) {
        ...
        var a, t = e,
            n = '<a href="javascript:void(0)" class="' + i.className + '" tabindex="-1" title="' + r(i.title) + '">' + i.label + "</a>";
        e.setup = (a = t.setup, function () {
            if (i.append) {
                var s = $(t.$input.context).attr("id"), r = ($("#" + s), t.settings.render.item);
                t.settings.render.item = function (i) {
                    return a = r.apply(e, arguments), t = n, s = a.search(/(<\/[^>]+>\s*)$/), a.substring(0, s) + t + a.substring(s);
                    var a, t, s
                }
            }
            a.apply(e, arguments), e.$control.on("click", "." + i.className, function (e) {
...
var $body = $("body"), $html = $("html"), $document = $(document), $window = $(window),
    $page_content = $("#page_content"), $page_content_inner = $("#page_content_inner"),
    $sidebar_main = $("#sidebar_main"), $sidebar_main_toggle = $("#sidebar_main_toggle"),
    $sidebar_secondary = $("#sidebar_secondary"), $sidebar_secondary_toggle = $("#sidebar_secondary_toggle"),
    $topBar = $("#top_bar"), $pageHeading = $("#page_heading"), $pageAside = $("#page_aside"),
    $pageOverflow = $("#page_overflow"), $header_main = $("#header_main"), header__main_height = 48;
altair_page_onload = {
    init: function () {
    ...
    hide_content_sidebar: function () {
        $body.hasClass("header_double_height") || $html.css({paddingRight: scrollbarWidth(), overflow: "hidden"})
    }, show_content_sidebar: function () {
        $body.hasClass("header_double_height") || $html.css({paddingRight: "", overflow: ""})
    }
}, altair_forms = {
    init: function () {
            ...
            if (!e.hasClass("selectized")) {
                ...
                e.after('<div class="selectize_fix"></div>').selectize({
                    ...
                    onInitialize: function () {
                        e[0].selectize.isRequired && e.prop("required", !0)
                    }
                })
            }
        ...
        (e ? $(e).find("[data-md-select2-delayed]") : $("[data-md-select2],.md-select2")).each(function () {
            var e = $(this);
            e.hasClass("select2-hidden-accessible") || e.select2({closeOnSelect: !1}), e.on("select2:open", function (e) {
                var i = $(".select2-dropdown");
                i.hide(), setTimeout(function () {
                    i.velocity("slideDown", {duration: 150, easing: easing_swiftOut})
                }, 50)
            })
        })
    }, switches: function (e) {
        ...
        i.length && i.each(function () {
            if (!$(this).siblings(".switchery").length) {
                var e = $(this).attr("data-switchery-size"), i = $(this).attr("data-switchery-color"),
                    a = $(this).attr("data-switchery-secondary-color"), t = new Switchery(this, {
        ...
        window.ParsleyConfig = window.ParsleyConfig || {}, window.ParsleyConfig.validators = window.ParsleyConfig.validators || {}, window.ParsleyConfig.validators.date = {
            fn: function (e) {
                ...
                var i = e.split(/[.\/-]+/), a = parseInt(i[1], 10), t = parseInt(i[0], 10), n = parseInt(i[2], 10);
                if (0 == n || 0 == t || t > 12) return !1;
                var s = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
                return (n % 400 == 0 || n % 100 != 0 && n % 4 == 0) && (s[1] = 29), a > 0 && a <= s[t - 1]
            }, priority: 256
        }
    }, dynamic_fields: function (e, i, a) {
        function t(e, i, a) {
            var t = $("#" + i).html(), n = Handlebars.compile(t)({index: a || 0, counter: a ? "__" + a : "__0"});
        ...
        (e ? $(e).find("[data-dynamic-fields]") : $("[data-dynamic-fields]")).each(function () {
            var e = $(this).attr("dynamic-fields-counter", 0), n = e.data("dynamicFields");
            a || t(e, n), e.on("click", ".btnSectionClone", function (a) {
                a.preventDefault(), e.find(".btnSectionClone").replaceWith('<a href="#" class="btnSectionRemove"><i class="material-icons md-24">&#xE872;</i></a>');
                var s = parseInt(e.attr("dynamic-fields-counter")) + 1;
                e.attr("dynamic-fields-counter", s), t(e, n, s), i && $window.resize()
            }).on("click", ".btnSectionRemove", function (e) {
                e.preventDefault(), $(this).closest(".form_section").next(".form_hr").remove().end().remove(), i && $window.resize()
            })
        })
    }
}, altair_main_sidebar = {
    init: function () {
        ...
        $sidebar_main.find(".menu_section > ul").find("li").each(function () {
            ...
            e.preventDefault();
            var i = $(this), a = i.next("ul").is(":visible") ? "slideUp" : "slideDown",
                t = $sidebar_main.hasClass("accordion_mode");
            i.next("ul").velocity(a, {
                duration: 400, easing: easing_swiftOut, begin: function () {
        ...
        e.length && (e.selectize({
            options: [{id: 1, title: "English", value: "gb"}, {
                id: 2,
                title: "French",
                value: "fr"
            }, {id: 3, title: "Chinese", value: "cn"}, {id: 4, title: "Dutch", value: "nl"}, {
                id: 5,
                title: "Italian",
                value: "it"
            }, {id: 6, title: "Spanish", value: "es"}, {id: 7, title: "German", value: "de"}, {
                id: 8,
                title: "Polish",
                value: "pl"
            }],
        ...
        $sidebar_main_toggle.hide(), $sidebar_main.find(".menu_section > ul").children("li").each(function () {
            $(this).children("ul").length ? ($(this).addClass("sidebar_submenu"), $(this).find(".act_item").length && $(this).addClass("current_section")) : $(this).attr({"data-uk-tooltip": "{pos:'right'}"})
    ...
    _heading: function () {
        ...
        if ($pageAside.length) {
            function e() {
                var e = $window.height(), i = $pageAside.offset().top;
    ...
    init: function () {
        ...
        $(".md-card-fullscreen-activate").on("click", function () {
            ...
            if (!e.hasClass("md-card-fullscreen")) {
                var i = e.height(), a = $(this).hasClass("toolbar_fixed"), t = e.width(), n = $body.scrollTop(),
                    s = e.offset();
                e.after('<div class="md-card-placeholder" style="width:' + t + "px;height:" + i + 'px;"/>'), e.addClass("md-card-fullscreen").css({
                    width: t,
                    height: i,
                    left: s.left,
                    top: s.top - n
                }).velocity({left: 0, top: 0}, {
                    duration: 400, easing: easing_swiftOut, begin: function (i) {
                        var a = e.find(".md-card-toolbar");
                        a.length ? a.prepend('<span class="md-icon md-card-fullscreen-deactivate material-icons uk-float-left">&#xE5C4;</span>') : e.append('<span class="md-icon md-card-fullscreen-deactivate material-icons uk-position-top-right" style="margin:10px 10px 0 0">&#xE5CD;</span>'), altair_page_content.hide_content_sidebar()
                    }
            ...
            var e = $(".md-card-placeholder"), i = e.height(), a = e.width(), t = $body.scrollTop(),
                n = e.offset().top - t, s = e.offset().left, r = $(".md-card-fullscreen"),
                o = r.hasClass("mdToolbar_fixed");
            r.velocity({height: i, width: a}, {
                duration: 400, easing: easing_swiftOut, begin: function (e) {
            ...
            }).velocity({left: s, top: n}, {
                duration: 400, easing: easing_swiftOut, complete: function (i) {
        ...
        $(".md-expand").velocity("transition.expandIn", {
            stagger: 175,
            drag: !0
        }), $(".md-expand-group").children().velocity("transition.expandIn", {stagger: 175, drag: !0})
        ...
        var e = $(".md-card-single");
        if (e && $body.hasClass("header_double_height")) {
            function i() {
                var i = $window.height() - (2 * header__main_height + 12);
                e.find(".md-card-content:first").innerHeight(i)
            }
        ...
        $(".md-card-close").on("click", function (e) {
            ...
            e.preventDefault();
            var i = $(this), a = i.closest(".md-card");
    ...
    }, card_progress: function (e, i, a) {
        (e ? $(e).children(".md-card-toolbar") : $("[data-toolbar-progress]")).each(function () {
            var e = $(this), t = i ? parseInt(i) : parseInt(e.attr("data-toolbar-progress")),
                n = e.attr("data-toolbar-progress-steps");
            if (a || n) if (t > 66) var s = "#dcedc8"; else if (t > 33) s = "#ffecb3"; else s = "#ffcdd2"; else {
            ...
            e.css({background: "-moz-linear-gradient(left, " + s + " " + t + "%, #fff " + t + "%)"}).css({background: "linear-gradient(to right,  " + s + " " + t + "%, #fff " + t + "%)"}).css({background: "-webkit-linear-gradient(left, " + s + " " + t + "%, #fff " + t + "%)"})
        })
    }, list_outside: function () {
        var e = $(".md-list-outside-wrapper"), i = e.children(".md-list-outside-inner");
        if (e && $body.hasClass("header_double_height")) {
            function a() {
                var a = $window.height() - (2 * header__main_height + 10);
                e.height(a), i.length && i.height(a)
            }

            a(), $window.on("debouncedresize", function () {
                a()
            }), i.length ? altair_helpers.custom_scrollbar(i) : altair_helpers.custom_scrollbar(e)
        }
    }, inputs: function (e) {
        (void 0 === e ? $(".md-input") : $(e).find(".md-input")).each(function () {
            if (!$(this).closest(".md-input-wrapper").length) {
                var e = $(this), i = "";
                if (e.is('[class*="uk-form-width-"]')) for (var a = e.attr("class").split(" "), t = 0; t < a.length; t++) {
        ...
        function e(e) {
            e.closest(".md-fab-wrapper").addClass("md-fab-active"), e.velocity({scale: 0}, {
                duration: 140,
                easing: easing_swiftOut,
                complete: function () {
                    e.velocity({scale: 1}, {duration: 140, easing: easing_swiftOut}).children().toggle()
                }
            })
        }

        function i(e) {
            e.closest(".md-fab-wrapper").removeClass("md-fab-active"), e.velocity({scale: 0}, {
                duration: 140,
                easing: easing_swiftOut,
                complete: function () {
                    e.velocity({scale: 1}, {duration: 140, easing: easing_swiftOut}).children().toggle()
        ...
        $(".md-fab-speed-dial,.md-fab-speed-dial-horizontal").each(function () {
            ...
            t.is("[data-fab-hover]") ? t.on("mouseenter", function () {
                t.addClass("md-fab-over"), clearTimeout(a), setTimeout(function () {
                    e(n)
                }, 100)
            }).on("mouseleave", function () {
                i(n), a = setTimeout(function () {
        ...
        e && (e.children("i").on("click", function (i) {
            ...
            e.hasClass("md-fab-active") && ($(i.target).closest(e).length || (e.css("width", "").removeClass("md-fab-active"), setTimeout(function () {
        ...
        $html.hasClass("lte-ie9") || (Waves.attach(".md-btn-wave,.md-fab-wave", ["waves-button"]), Waves.attach(".md-btn-wave-light,.md-fab-wave-light", ["waves-button", "waves-light"]), Waves.attach(".wave-box", ["waves-float"]), Waves.init({delay: 300}))
    }
}, altair_helpers = {
    truncate_text: function (e) {
        ...
        if (i.length && i.each(function () {
            var e = $(this).attr("data-show-delay") ? parseInt($(this).attr("data-show-delay")) : 0, i = $(this),
                a = i.children().length;
            i.children().each(function (e) {
                $(this).css({"-webkit-animation-delay": 100 * e + "ms", "animation-delay": 100 * e + "ms"})
            }), setTimeout(function () {
                i.waypoint({
                    handler: function () {
                    ...
                    }, context: "window", offset: "90%"
                })
            }, e)
        }), e) {
            var a = $(e).addClass("hierarchical_show hierarchical_show_inView"), t = a.children().length;
        ...
        if (i.length && i.each(function () {
            var e = $(this),
                ...
                a = i.length, t = e.attr("data-slide-context") ? e.closest(e.attr("data-slide-context"))[0] : "window";
            ...
            console.log(t), n >= 1 && (t.each(function (e) {
                $(this).css({"-webkit-animation-delay": 100 * e + "ms", "animation-delay": 100 * e + "ms"})
            }), setTimeout(function () {
        ...
        if (!$body.find(".content-preloader").length) {
            ...
            (void 0 !== a ? $(a) : $body).append('<div class="content-preloader content-preloader-' + i + '" style="height:' + n + "px;width:" + t + "px;margin-left:-" + t / 2 + 'px">' + r + "</div>"), setTimeout(function () {
        ...
        void 0 !== $.fn.dense && $("img").attr("data-dense-cap", 2).dense({glue: "@", ping: !1})
    }, full_screen: function () {
        var e = $("#full_screen_toggle");
        e.length && e.on("click", function (i) {
            i.preventDefault(), screenfull.enabled && (screenfull.request(), e.children(".material-icons").text("fullscreen_exit"), screenfull.isFullscreen && (screenfull.exit(), e.children(".material-icons").text("fullscreen"))), $window.resize()
        })
    }, table_check: function () {
        $table_check = $(".table_check"), $table_check.each(function () {
            var e = $(this), i = e.find(".check_all"), a = e.find(".check_row");
        ...
        $table_tree = $(".table_tree"), $table_tree.each(function () {
            var e = $(this), i = e.find(".check_childrens"), a = e.find(".check_row"),
        ...
        detectIE() && ($("svg,canvas,video").each(function () {
            ...
            $("svg,canvas,video").each(function () {
                var e = $(this), i = $(this).attr("height"), a = $(this).attr("width");
        ...
        e && $(window).on("scroll", function () {
            $(window).scrollTop() > 120 ? e.fadeIn() : e.fadeOut()
        })
    }
}, altair_uikit = {
    reinitialize_grid_margin: function () {
        ...
        $("[data-accordion-section-open]").each(function () {
            ...
            setTimeout(function () {
                var i = e.data();
                if (sectOpen = i.accordionSectionOpen.toString().split(","), e.children(".uk-accordion-title.uk-active").each(function () {
                    $(this).trigger("click")
                }), !i.accordion.options.collapse && sectOpen.length > 1) for (var a = 0; a <= sectOpen.length; a++) e.children(".uk-accordion-title").eq(sectOpen[a] - 1).trigger("click"); else e.children(".uk-accordion-title").eq(sectOpen[0] - 1).trigger("click")
            }, 220)
        })
    }
};